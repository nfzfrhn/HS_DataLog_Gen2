...
#define USBD_PRODUCT_FS_STRING        "STWIN Multi-Sensor Streaming"
#define USBD_CONFIGURATION_FS_STRING  "STWIN Config"
#define USBD_INTERFACE_FS_STRING      "STWIN Interface"
#define USBD_OS_STRING                "STWIN Sensor Streaming"
...
uint8_t *USBD_WCID_STREAMING_USRStringDesc (USBD_SpeedTypeDef speed, uint8_t idx, uint16_t *length); /* Implemented in the class file for wcid */
#endif /* USB_SUPPORT_USER_STRING_DESC */  

/* Private variables ---------------------------------------------------------*/
USBD_DescriptorsTypeDef WCID_STREAMING_Desc = {
  USBD_WCID_STREAMING_DeviceDescriptor,
  USBD_WCID_STREAMING_LangIDStrDescriptor, 
  USBD_WCID_STREAMING_ManufacturerStrDescriptor,
  USBD_WCID_STREAMING_ProductStrDescriptor,
  USBD_WCID_STREAMING_SerialStrDescriptor,
  USBD_WCID_STREAMING_ConfigStrDescriptor,
  USBD_WCID_STREAMING_InterfaceStrDescriptor,  
};
